...
export function SignUpForm({ className, ...props }) {
  return (
    <div className={cn("flex flex-col gap-6 mt-10 md:mt-0", className)} {...props}>
          ...
          <form className="p-6 md:p-8">
            <div className="flex flex-col gap-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                <Button variant="outline" type="button" className="w-full hover:bg-red-50">
              ...
              <div className="text-center text-sm">
                ...
                <Link to="/auth/login" className="text-red-600 hover:text-red-700 underline underline-offset-4">
                  Login
                </Link>
              </div>
            </div>
