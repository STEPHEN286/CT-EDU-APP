...
export function SignUpForm({ className, ...props }) {
 ...
 const {mutate, isError, error} =  usePostData ("registerapi.php")
  ...
  return (
   ...
   <div className="mb-4">
      ...
      <div
        className={cn("flex flex-col gap-6 mt-10 md:mt-0", className)}
        {...props}
      >
        <Card className="overflow-hidden p-0 shadow-none">
          <CardContent className="grid p-0 lg:grid-cols-2 max-w-6xl">
            <form onSubmit={handleSubmit(onSubmit)} className="p-6 md:p-8">
              <div className="flex flex-col gap-6">
                <div className="flex flex-col items-center text-center">
                  <h1 className="text-2xl font-bold">Regiter Now</h1>
                  <p className="text-muted-foreground text-balance">
                    Join our innovative e-learning platform designed to empower
